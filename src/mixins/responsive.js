...
export const maxDeviceSize = device => `${maxWidth(device.width)} ${maxHeight(device.height)}`;
export const minDeviceSize = device => `${minWidth(device.width)} ${minHeight(device.height)}`;
