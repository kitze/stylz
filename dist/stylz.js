...
var _mixinsAnimations = require('./mixins/animations');

var animations = _interopRequireWildcard(_mixinsAnimations);

var _mixinsColor = require('./mixins/color');

var color = _interopRequireWildcard(_mixinsColor);

var _mixinsFonts = require('./mixins/fonts');

var fonts = _interopRequireWildcard(_mixinsFonts);

var _mixinsGradients = require('./mixins/gradients');

var gradients = _interopRequireWildcard(_mixinsGradients);

var _mixinsImages = require('./mixins/images');

var images = _interopRequireWildcard(_mixinsImages);

var _mixinsLayout = require('./mixins/layout');

var layout = _interopRequireWildcard(_mixinsLayout);

var _mixinsLook = require('./mixins/look');

var look = _interopRequireWildcard(_mixinsLook);

var _mixinsPosition = require('./mixins/position');

var position = _interopRequireWildcard(_mixinsPosition);

var _mixinsPseudo = require('./mixins/pseudo');

var pseudo = _interopRequireWildcard(_mixinsPseudo);

var _mixinsSize = require('./mixins/size');
...
var animate = function animate() {
  var time = arguments.length <= 0 || arguments[0] === undefined ? 250 : arguments[0];
  var property = arguments.length <= 1 || arguments[1] === undefined ? "all" : arguments[1];
  var animation = arguments.length <= 2 || arguments[2] === undefined ? "linear" : arguments[2];
...
var darken = function darken(color, amount) {
  return (0, _color2['default'])(color).blacken(amount).hexString();
};
 ...
 * @return {String}
 */
var opacify = function opacify(color, alpha) {
  return (0, _color2['default'])(color).alpha(alpha).rgbString();
};
exports.opacify = opacify;

},{"color":1}],10:[function(require,module,exports){
/** @module Fonts */
...
var topToBottom = function topToBottom(fromColor, toColor) {
  return {
...
var backgroundImg = function backgroundImg(url, cover) {
  return _extends({
...
var flexGrid = function flexGrid() {
  var cols = arguments.length <= 0 || arguments[0] === undefined ? 1 : arguments[0];
  return {
    flex: "0 0 " + 100 / cols + "%"
  };
};
 ...
 * @param {String} color
 */
var bottomInsideBorder = function bottomInsideBorder(size, color) {
  return {
    boxShadow: 'inset 0px -' + size + 'px 0px ' + color
  };
};

exports.bottomInsideBorder = bottomInsideBorder;
/**
 ...
 */
var customLink = function customLink(color) {
  var underline = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
  return _extends({
    color: color,
    cursor: 'pointer',
    paddingBottom: 3,
    borderBottom: '1px solid ' + _colors2['default'].transparent
  }, underline === true && {
    ':hover': {
 ...
 * @param {number} side
 */
var cornerOffset = function cornerOffset() {
  var offsetPx = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];
  var side = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
  return _extends({}, side === 1 && {
    top: offsetPx,
    left: offsetPx
  }, side === 2 && {
    top: offsetPx,
...
var hoverAndClick = function hoverAndClick(color, darkenColor, useBackgroundColor, animation, active) {
  ...
  if (useBackgroundColor === undefined) useBackgroundColor = false;
  return (function () {

    var property = useBackgroundColor === true ? 'backgroundColor' : 'color';

    return _extends({
      cursor: 'pointer'
    }, animation === true ? (0, _animations.animate)() : animation === undefined || animation === false ? {} : { transition: animation }, color !== undefined && _defineProperty({}, property, color), {
      ':hover': _defineProperty({}, property, darkenColor)
    }, active !== undefined && {
      ':active': _defineProperty({}, property, active === true ? (0, _color.darken)(darkenColor, 0.8) : active)
    });
  })();
};
 ...
 */
var maxSize = function maxSize(width) {
  var height = arguments.length <= 1 || arguments[1] === undefined ? width : arguments[1];
  return (function () {
    return {
      maxWidth: width,
 ...
 * @param size
 */
var minSize = function minSize(width) {
  var height = arguments.length <= 1 || arguments[1] === undefined ? width : arguments[1];
  return (function () {
    return {
      minWidth: width,
 ...
 * @param height
 */
var maxHeight = function maxHeight(height) {
  return {
    height: height,
    maxHeight: height
  };
 ...
 * @param height
 */
var fixedHeight = function fixedHeight(height) {
  return {
    height: height,
    maxHeight: height,
    minHeight: height
 ...
 * @param height
 */
var fixedWidth = function fixedWidth(width) {
  return {
    width: width,
    maxWidth: width,
    minWidth: width
...
var fillParent = function fillParent() {
  return _extends({}, fixedHeight('100%'), fixedWidth('100%'), {
    overflow: 'hidden'
  });
};
...
var padding = {
   ...
   * @param right
   */
  horizontal: function horizontal(left) {
    var right = arguments.length <= 1 || arguments[1] === undefined ? left : arguments[1];
    return (function () {
      return {
        paddingLeft: left,
        paddingRight: right
   ...
   * @param right
   */
  vertical: function vertical(left) {
    var right = arguments.length <= 1 || arguments[1] === undefined ? left : arguments[1];
    return (function () {
      return {
        paddingTop: left,
   ...
   * @param horizontal
   */
  both: function both(vertical) {
    var horizontal = arguments.length <= 1 || arguments[1] === undefined ? vertical : arguments[1];
    return (function () {
      return {
        paddingTop: vertical,
...
var margin = {
   ...
   * @param value
   */
  vertical: function vertical(top) {
    var bottom = arguments.length <= 1 || arguments[1] === undefined ? top : arguments[1];
    return (function () {
      return {
        marginTop: top,
        marginBottom: bottom
 ...
 * @param size
 */
var toInt = function toInt(size) {
  return !isString(size) ? size : parseInt(size.split('px')[0]);
};
exports.toInt = toInt;
